...
const ProfilePage = ({ Kepengurusan, BPH }: ProfilePageProps) => {
    ...
    useEffect(() => {
        ...
        // Cek ukuran layar saat pertama kali komponen dimuat
        checkScreenSize();
...
const BPHDesktop = ({ BPH }: { BPH: BPH }) => {
    ...
    const COPendidikan = pendidikan.find((e) => e.jabatan !== "anggota")
    const COInternasionalisasi = internasionalisasi.find((e) => e.jabatan !== "anggota")
    const COKewirausahaan = kewirausahaan.find((e) => e.jabatan !== "anggota")
    const COKominfo = kominfo.find((e) => e.jabatan !== "anggota")
    const COLingkungan = lingkungan.find((e) => e.jabatan !== "anggota")
    const COPengabdian = pengabdian.find((e) => e.jabatan !== "anggota")
            ...
            <div className="grid grid-cols-6 w-full items-start">
                <div className="col-span-1 flex flex-col gap-1 justify-center items-center">
                    ...
                    <ul className="flex flex-col gap-1 text-start mx-2">
                        <Link href={`/profile/${COPendidikan?.id}`} className="font-semibold">- {COPendidikan?.name}</Link>
                        {pendidikan?.filter((e) => e.jabatan === "anggota")?.map((e) => (
                ...
                <div className="col-span-1 flex flex-col gap-1 justify-center items-center">
                    ...
                    <ul className="flex flex-col gap-1 text-start mx-2">
                        <Link href={`/profile/${COInternasionalisasi?.id}`} className="font-semibold">- {COInternasionalisasi?.name}</Link>
                        {internasionalisasi?.filter((e) => e.jabatan === "anggota")?.map((e) => (
                            <Link href={`/profile/${e.id}`} key={e.id}>- {e.name}</Link>
                        ))}
                    </ul>
                </div>
                <div className="col-span-1 flex flex-col gap-1 justify-center items-center">
                    ...
                    <ul className="flex flex-col gap-1 text-start mx-2">
                        <Link href={`/profile/${COKewirausahaan?.id}`} className="font-semibold">- {COKewirausahaan?.name}</Link>
                        {kewirausahaan?.filter((e) => e.jabatan === "anggota")?.map((e) => (
                            <Link href={`/profile/${e.id}`} key={e.id}>- {e.name}</Link>
                        ))}
                    </ul>
                </div>
                <div className="col-span-1 flex flex-col gap-1 justify-center items-center">
                    ...
                    <ul className="flex flex-col gap-1 text-start mx-2">
                        <Link href={`/profile/${COLingkungan?.id}`} className="font-semibold">- {COLingkungan?.name}</Link>
                        {lingkungan?.filter((e) => e.jabatan === "anggota")?.map((e) => (
                            <Link href={`/profile/${e.id}`} key={e.id}>- {e.name}</Link>
                        ))}
                    </ul>
                </div>
                <div className="col-span-1 flex flex-col gap-1 justify-center items-center">
                    ...
                    <ul className="flex flex-col gap-1 text-start mx-2">
                        <Link href={`/profile/${COKominfo?.id}`} className="font-semibold">- {COKominfo?.name}</Link>
                        {kominfo?.filter((e) => e.jabatan === "anggota")?.map((e) => (
                            <Link href={`/profile/${e.id}`} key={e.id}>- {e.name}</Link>
                        ))}
                    </ul>
                </div>
                <div className="col-span-1 flex flex-col gap-1 justify-center items-center">
                    ...
                    <ul className="flex flex-col gap-1 text-start mx-2">
                        <Link href={`/profile/${COPengabdian?.id}`} className="font-semibold">- {COPengabdian?.name}</Link>
                        {pengabdian?.filter((e) => e.jabatan === "anggota")?.map((e) => (
                            <Link href={`/profile/${e.id}`} key={e.id}>- {e.name}</Link>
                        ))}
                    </ul>
                </div>

...
const SidebarNavigation = () => {
    ...
    const routesDashboard: RoutesType[] = useMemo(() => 
        [
            {
                path: "/admin",
                name: "Dashboard",
    ...
    const routesGovernance = {
        primary: [
            { name: "Ketua", path: "ketua" },
            { name: "Wakil Ketua", path: "wakilKetua" },
            { name: "Sekretaris", path: "sekretaris" },
            { name: "Bendahara", path: "bendahara" },
        ],
        bph: [
            {
                name: "Pendidikan",
            ...
            },
            {
                ...
                path: "internasionalisasi",
                icon: (
                    <svg xmlns="http://www.w3.org/2000/svg" fill="#4B5563" width="100%" height="100%" className="bi bi-briefcase-fill" viewBox="0 0 24 24">
